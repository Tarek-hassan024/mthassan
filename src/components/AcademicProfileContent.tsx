...
export default function AcademicProfileContent({ badge = "Academic Portfolio" }: { badge?: string }) {
  ...
  return (
    <Container className="pt-10">
      ...
      <section className="mt-10">
        <SectionHeading icon={BriefcaseBusiness} kicker="Experience" title="Professional Experience" />
      ...
      <section className="mt-10">
        <SectionHeading icon={Award} kicker="Recognition" title="Grants and Scholarships" />
        <div className="grid gap-4 lg:grid-cols-2">
